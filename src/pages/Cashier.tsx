...
// import { useCashierTableColumn } from '@/components/Cashier/hooks/useCashierTableColumn';
...
//   const columns = useCashierTableColumn({
//     t,
//     searchValues,
//     setSearchValues,
//     sortBy: query.sortBy || '',
...
//       id: item.id,
//       shops:
//         (`${item.store?.shop?.user?.firstName}` &&
//           `${item.store?.shop?.user?.lastName}`) ||
//         '',
//       shopType: item.store?.shop?.type || '',
